    ...
    <footer className="bg-dark text-white py-4">
      <div className="container">
        <div className="row text-center">
          <div className="col-md-4">
            ...
            <p className="text-start">
              SkyVault — это умный облачный сервис. В нём можно хранить фото,
              видео, документы и контакты. Умеет загружать файлы автоматически и
              хранит их на защищённых серверах.
            </p>
          </div>
          <div className="col-md-4">
            ...
            <ul className="list-unstyled">
              <li>
                <a
                  href="mailto:support@skyvault.com"
                  className="text-white text-decoration-none"
                >
                  support@skyvault.com
                </a>
              </li>
              <li>
                <a
                  href="tel:+79817514877"
                  className="text-white text-decoration-none"
                >
                  +7 (981) 751-48-77
                </a>
        ...
        <div className="d-flex align-items-center justify-content-center text-start mt-4">
          <p className="mb-0">
            &copy; 2025 SkyVault. Проект не предназначен для коммерческого
            применения
            <br />
