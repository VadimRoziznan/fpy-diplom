...
cp .env_example .env
```
В файле .env необходимо указать параметры подключения к базе данных и другие конфигурации. Аналогично, скопируйте файл .env_example в новый файл .env в папке backend/SkyVault и отредактируйте его.
